...
def Jtag_test():
	button_J_pass = Button(top,'PASS','green',info_jtag_pass)
 	button_J_pass.pack()
    	button_J_pass.place(x=170,y=280)

	button_J_fail = Button(top,'FAIL','red',info_jtag_fail)
    	button_J_fail.pack()
    	button_J_fail.place(x=320,y=280)

	os.system('export scriptsFolder=`dirname /Users/pe/Desktop/Joker8/Bin/Resources/openocd-t2.cfg`')
	os.system('/Users/pe/Desktop/Joker8/Bin/Resources/launchopenocd.sh /var/tmp/joker8 /Users/pe/Desktop/Joker8/Bin/Resources/openocd-0.7.0 /Users/pe/Desktop/Joker8/Bin/Resources/openocd-t2.cfg 2 ft2232_serial\ OLVUP7C?A telnet_port\ 4450 tcl_port\ 6670 gdb_port\ 3335')
...
'''
	...
	if 'k24.cpu tap/device found' in result:
		...
		Label_result = Tkinter.Label(top,text='PASS',font='Helvetica -12 bold',width=25,height=2,bg='green')
    		Label_result.pack()
    		Label_result.place(x=170,y=280)
...
def info_jtag_pass():
	...
	Label_PORTA_over = Tkinter.Label(top,width=200,height=3)
    	Label_PORTA_over.pack()
    	Label_PORTA_over.place(x=17,y=280)
...
def getoutput_result():
	pass
#	global result
#	result = os.system('/Users/pe/Desktop/Joker8/Bin/Resources/launchopenocd.sh /var/tmp/joker8 /Users/pe/Desktop/Joker8/Bin/Resources/openocd-0.7.0 /Users/pe/Desktop/Joker8/Bin/Resources/openocd-t2.cfg 2 ft2232_serial\ OLVUP7C?A telnet_port\ 4450 tcl_port\ 6670 gdb_port\ 3335')
...
def layout():
	...
	global top,Label_PORTA,Label_PORTB,Text_dataline,f,ISN,path
	...
	top = Tkinter.Tk()
   	...
   	Label_PORTA = Tkinter.Label(top,text='PORTA',font='Helvetica -12 bold',width=70,height=2,bg='yellow')
    	...
    	Label_dataline = Tkinter.Label(top,text='LOG:')
    	Label_dataline.pack()
    	Label_dataline.place(x=3,y=410)

	Label_ISN = Tkinter.Label(top,text='ISN:')
	Label_ISN.pack()
	Label_ISN.place(x=3,y=370)

	e_ISN = Tkinter.StringVar()
	ISN = Tkinter.Entry(top,textvariable = e_ISN,width=44)
	e_ISN.set('')
	ISN.pack()
	ISN.place(x=43,y=370)

    	Text_dataline = Tkinter.Text(top,width=63,height=22)
    	Text_dataline.pack()
    	Text_dataline.place(x=5,y=446)
